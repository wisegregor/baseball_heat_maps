...
I'm going to attempt to predict those rates using the Marcel projection system. Following this example from beyondtheboxscore. The author, Henry Druschel, explains the origins of the Marcel projections and a concrete example which I followed to predict our predictors.
